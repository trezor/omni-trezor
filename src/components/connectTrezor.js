  ...
  render() {
    return(
      <article className="connect-trezor">
        ...
        <div className="preflight-checklist-container">
          <div className="checklist">
            ...
            <ul>
              ...
              <li>Read the <a href="https://github.com/trezor/omni-trezor/blob/trezor/TERMS.md" target="_blank" rel="noopener noreferrer">Terms of Use?</a></li>
            </ul>
          </div>
        </div>
        ...
        <small>By continuing you agree to the <a href="https://github.com/trezor/omni-trezor/blob/trezor/TERMS.md" target="_blank" rel="noopener noreferrer">Terms of Use.</a></small>
      </article>
    )
  }
